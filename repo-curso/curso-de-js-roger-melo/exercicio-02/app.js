...
// console.log('Grandes poderes trazem grandes reponsabilidades')
...
const allEpisodes = 'O numero de epsódios é: ' + episodes
...
- Exiba a "newName" no console;
*/
let newName1 = `${name[0].toUpperCase()}${name.slice(1, 6)} ${name[7].toUpperCase()}${name.slice(8,12)}`
