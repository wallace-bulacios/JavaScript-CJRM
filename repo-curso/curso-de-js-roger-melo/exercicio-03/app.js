...
const dessert = `${dogNames[0].slice(3, 5)}${dogNames[1].slice(2, 4)}${dogNames[3].slice(5,7).replace('d', 'n')}`

console.log(dessert)

console.log(`A ${dessert} é um doce à base de coco, tradicional na America Latina e em Angola`)
